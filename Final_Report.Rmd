...
One thing that immediately stuck out was that some intersections were accident hotspots. For example, as we did a deep dive earlier on the intersection between Massachusetts Avenue and Southampton street which contained 37 accidents, and the grid view showed us that in this particular area this intersection was a blend of Shared Lane Markings (SLM) and Buffered Bike Lanes (BFBL).
